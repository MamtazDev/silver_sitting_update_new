...
const Register = () => {
  ...
  return (
    <section>
      <div style={{ width: "100%" }} className={styles.mainRegisterContainer}>
        {/* 1st section */}
        {registerPage.step === 1 && (
          <div
            style={{ padding: "30px" }}
            className={styles.register1stSection}
          >
            <h3>Register</h3>
            <h6>I am...</h6>
        ...
        {/* 2nd section */}
        {registerPage.step === 2 && (
          <form className="px-2 px-lg-5  " onSubmit={handleSubmit}>
            <h3>Register</h3>
            ...
            <div className={styles.twoInputContainer}>
              ...
              <div className="w-50">
                ...
                <input type="text" name="lastName" className="w-100" required />
              </div>
            </div>
            ...
            <div>
              ...
              <input type="text" name="streetOrHouseNumber" className="w-100" />
            </div>
            {/* 5th row */}
            <div className={styles.twoInputContainer}>
              <div className="w-50">
            ...
            {isLoading ? (
              <div className={`text-center ${styles.loginButtonContainer}`}>
                <button className={`btn disabledButton`} type="button" disabled>
        ...
        {registerPage.step === 3 && (
          <div style={{margin:"0"}} className={styles.success}>
            <img src={sms.src} alt="" />
